...
export default function DmPage() {
  ...
  useEffect(() => {
    setMounted(true)
    // 客户端读取 URL 参数，避免 SSG 时 useSearchParams 报错
    const params = new URLSearchParams(window.location.search)
    setConvId(params.get('conv'))
            ...
            >
              ...
              >
                {msg.recalled_at ? (
                  ...
                  <div className={styles.bubbleContent} dangerouslySetInnerHTML={{ __html: renderClient(msg.content) }} />
                )}
              </div>
